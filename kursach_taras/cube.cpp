...
void Cube::matrixInit()
{
	...
	dots_[4][0] = positionX_ - (length_ / 2); dots_[4][1] = positionY_ - (length_ / 2); dots_[4][2] = positionZ_ - (length_ / 2);
	dots_[5][0] = positionX_ - (length_ / 2); dots_[5][1] = positionY_ + (length_ / 2); dots_[5][2] = positionZ_ - (length_ / 2);
	dots_[6][0] = positionX_ + (length_ / 2); dots_[6][1] = positionY_ + (length_ / 2); dots_[6][2] = positionZ_ - (length_ / 2);
	dots_[7][0] = positionX_ + (length_ / 2); dots_[7][1] = positionY_ - (length_ / 2); dots_[7][2] = positionZ_ - (length_ / 2);
